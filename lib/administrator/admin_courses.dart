...
class _AdminCourses extends State<AdminCourses> {
  Query _ref ;
  DatabaseReference reference = FirebaseDatabase.instance.reference().child('course');

  @override
  void initState() {
    super.initState();
    _ref =FirebaseDatabase.instance.reference().child('course').orderByChild('code');
  }
// Map myData ;
  // List getAllCourses = [];
  @override
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminAddCourse()));
        },
              ...
              Row(
                children: [
                  IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>AdminEditCourse(
